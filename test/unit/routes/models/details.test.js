...
import { detailsModel } from '../../../../src/routes/models/details.js'
import * as fetchPaymentDetailsModule from '../../../../src/services/fetch-payment-details.js'
import { getSchemeStaticData } from '../../../../src/common/utils/get-scheme-static-data.js'

describe('detailsModel', () => {
  afterEach(() => vi.clearAllMocks())

  test('detailsModel returns empty object if getPaymentDetails returns null', async () => {
    vi.spyOn(fetchPaymentDetailsModule, 'fetchPaymentDetails').mockResolvedValue(null)
  ...
  test('detailsModel returns summary if getPaymentDetails returns data', async () => {
    vi.spyOn(fetchPaymentDetailsModule, 'fetchPaymentDetails').mockResolvedValue({
